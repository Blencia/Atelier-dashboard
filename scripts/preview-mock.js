    ...
    boards: [
      {
        ...
        widgets: [
          { id: 'w1', type: 'bookmarks', w: 5, h: 3, color: '#8b9dff', settings: { folderId: byTitle('Dev'), folderPath: 'Barre de favoris / Dev', view: 'tiles', tile: 78, icon: 26, sort: 'manual', limit: 0, openIn: 'current', showCrumbs: true } },
