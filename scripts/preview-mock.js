...
(function () {
  ...
  const preset = {
    ...
    widgets: [
      ...
      { id: 'w3', type: 'clock', w: 3, h: 1, settings: { label: 'Laval', date: true, seconds: false, hour12: false } },
      ...
      { id: 'w5', type: 'bookmarks', w: 4, h: 2, settings: { folderId: byTitle('Outils'), folderPath: 'Barre de favoris / Outils', view: 'tiles', tile: 68, icon: 24, sort: 'manual', limit: 0, openIn: 'new', showCrumbs: true } },
